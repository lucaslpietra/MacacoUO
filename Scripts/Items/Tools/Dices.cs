...
namespace Server.Items
{
    public class Dices : Item, ITelekinesisable, ISecurable
    {
        ...
        public void Roll(Mobile from)
        {
            ...
            this.PublicOverheadMessage(MessageType.Emote, 0, true, "* rolando dados *"); // The first die rolls to a stop and shows:
            this.PublicOverheadMessage(MessageType.Emote, 0, true, "Primeiro dado rolou "+one);
            this.PublicOverheadMessage(MessageType.Emote, 0, true, "Segundo dado rolou " + two);
            this.PublicOverheadMessage(MessageType.Emote, 0, true, "Total " + (one+two));
