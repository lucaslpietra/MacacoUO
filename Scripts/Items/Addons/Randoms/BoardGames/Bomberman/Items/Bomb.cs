...
namespace Solaris.BoardGames
{
    ...
    public class Bomb : GamePiece
    {
        ...
        //master constructor
        public Bomb(BombBag bombbag) : base(0x2256, bombbag == null ? "Bombas" : "Bombas de "+bombbag.Owner.Name)
        {
            Hue = 1;
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.Write(BombBag);

            writer.Write(_Strength);
            writer.Write(_Candle);

            writer.Write(_Detonator);

            writer.Write(_BaddaBoom);
        }
        ...
        protected class FuseTimer : Timer
        {
            ...
            public FuseTimer(Bomb bomb)
                : base(TimeSpan.FromSeconds(BombermanSettings.EXPLODE_DELAY), TimeSpan.FromSeconds(1.0))
            {
