...
namespace Solaris.BoardGames
{
    ...
    public abstract class BombermanUpgrade : BombermanObstacle
    {
        ...
        {
            m.SendMessage("Voce pegou um powerup!");
        ...
        protected class DecayTimer : Timer
        {
            ...
            public DecayTimer(BombermanUpgrade upgrade)
                : base(TimeSpan.FromSeconds(BombermanSettings.UPGRADE_DECAY_DELAY), TimeSpan.FromSeconds(1.0))
            {
