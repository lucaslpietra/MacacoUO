    ...
    public abstract class TrapableContainer : BaseContainer, ITelekinesisable
    {
        ...
        public virtual bool ExecuteTrap(Mobile from)
        {
            if (this.m_TrapType != TrapType.None)
            {
                ...
                {
                    this.SendMessageTo(from, "Tem uma armadilha aqui mas GM eh pica.", 0x3B2);
                    return false;
                }
                    ...
                    case TrapType.ExplosionTrap:
                        {
                           // this.PrivateMessage("* disparou armadilha *", from); // You set off a trap!
                            ...
                            if (from.InRange(loc, 5))
                            {
                                ...
                                from.OverheadMessage("* se queimou *");
                            }
                    ...
                    case TrapType.MagicTrap:
                        {
                            ...
                            from.OverheadMessage("* tomou choque *");
                    ...
                    case TrapType.DartTrap:
                        {
                           // this.SendMessageTo(from, 502999, 0x3B2); // You set off a trap!
                            ...
                            if (from.InRange(loc, 3))
                            {
                                ...
                                from.OverheadMessage("* tomou flechada *");
                    ...
                    case TrapType.PoisonTrap:
                        {
                            ...
                            if (from.InRange(loc, 3))
                            {
                                ...
                                from.OverheadMessage("* gas venenoso *");
