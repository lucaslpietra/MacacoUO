...
namespace Server.Items
{
    public class GrimmochJournal1 : BaseBook
    {
        public static readonly BookContent Content = new BookContent(
            "The daily journal of Marte Nebroso", "Marte",
           new BookPageInfo(
                "Dia um :",
                "",
                "É uma grande visão, isso",
                "tumba primitiva, eu concordo",
                "com Tavara nisso.",
                "E nós temos uma boa equipe",
                "aqui, eles são fortes",
                "costas e uma boa"),
            new BookPageInfo(
                "atitude. estou um pouco",
                "preocupado com aqueles",
                "que funcionou como guias",
                "para nós, no entanto. Todos",
                "parecia bem o suficiente",
                "até revelarmos o",
                "imensas portas de pedra",
                "da estrutura da tumba"),
            new BookPageInfo(
                "em si. Parecia enviar",
                "um arrepio",
                "espinhos e pegá-los todos",
                "mexido com",
                "sussurrando. Eu vou",
                "assista a muitos deles",
                "com um olhar atento, mas",
                "Estou confiante de que não vamos"),
            new BookPageInfo(
                "tem algum real",
                "problemas na escavação.",
                "Estou especialmente orgulhoso de",
                "ver Thomas em pé",
                "fora - ele era bom",
                "contratar, apesar do",
                "avisos dele",
