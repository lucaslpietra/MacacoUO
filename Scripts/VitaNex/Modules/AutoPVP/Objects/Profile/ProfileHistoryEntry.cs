...
namespace VitaNex.Modules.AutoPvP
{
	public class PvPProfileHistoryEntry : PropertyObject, IEquatable<PvPProfileHistoryEntry>
	{
		...
		public virtual void GetHtmlString(Mobile viewer, StringBuilder html)
		{
			...
			html.AppendLine("Estatisticas da temporada: {0:#,0}".WrapUOHtmlBold(), Season);
			html.AppendLine();

			html.AppendLine("Estatisticas:".WrapUOHtmlBold());
			html.AppendLine();

			html.AppendLine("Participou: {0:#,0}", Battles);
			html.AppendLine("Vitorias: {0:#,0}", Wins);
			html.AppendLine("Derrotas: {0:#,0}", Losses);
			html.AppendLine();
			html.AppendLine("Pontos Totais: {0:#,0}", Points);
			html.AppendLine("Pontos Ganhos: {0:#,0}", PointsGained);
			html.AppendLine("Pontos Perdidos: {0:#,0}", PointsLost);
			html.AppendLine();
			html.AppendLine("Matou: {0:#,0}", Kills);
			html.AppendLine("Morreu: {0:#,0}", Deaths);
			html.AppendLine("Ressou: {0:#,0}", Resurrections);
			html.AppendLine("Tomou Dano: {0:#,0}", DamageTaken);
			html.AppendLine("Deu Dano: {0:#,0}", DamageDone);
			html.AppendLine("Recebeu Cura: {0:#,0}", HealingTaken);
			html.AppendLine("Curou: {0:#,0}", HealingDone);
			html.AppendLine();

			html.Append(String.Empty.WrapUOHtmlColor(Color.GreenYellow, false));
			html.AppendLine("Misc:");
