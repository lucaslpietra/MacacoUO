...
namespace VitaNex.Modules.AutoPvP
{
	public class AutoPvPStatistics : PropertyObject
	{
		...
		[CommandProperty(AutoPvP.Access)]
		public virtual int BattlesEnded { get { return AutoPvP.CountBattles(PvPBattleState.Terminando); } }

		[CommandProperty(AutoPvP.Access)]
		public virtual int BattlesPreparing { get { return AutoPvP.CountBattles(PvPBattleState.Preparando); } }

		[CommandProperty(AutoPvP.Access)]
		public virtual int BattlesQueueing { get { return AutoPvP.CountBattles(PvPBattleState.EmFila); } }

		[CommandProperty(AutoPvP.Access)]
		public virtual int BattlesRunning { get { return AutoPvP.CountBattles(PvPBattleState.Batalhando); } }
