...
namespace VitaNex.Modules.TrashCollection
{
	public class TrashCollectionProfileGump : HtmlPanelGump<TrashProfile>
	{
		...
		protected override void CompileMenuOptions(MenuGumpOptions list)
		{
			...
			{
				list.AppendEntry(new ListGumpEntry("Limpar Historico", OnClearHistory, HighlightHue));
				list.AppendEntry(new ListGumpEntry("Deletar Perfil", OnDeleteProfile, HighlightHue));
			}

			list.AppendEntry(new ListGumpEntry("Ver Historico", OnViewHistory, HighlightHue));

			list.AppendEntry(new ListGumpEntry("Ajuda", ShowHelp));
