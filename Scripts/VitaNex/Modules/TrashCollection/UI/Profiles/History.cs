...
namespace VitaNex.Modules.TrashCollection
{
	public sealed class TrashCollectionProfileHistoryGump : HtmlPanelGump<TrashProfile>
	{
		...
		protected override void CompileMenuOptions(MenuGumpOptions list)
		{
			...
			{
				list.AppendEntry(new ListGumpEntry("Limpar Historico", ClearHistory, HighlightHue));
				list.AppendEntry(new ListGumpEntry("Deletar Perfil", DeleteProfile, HighlightHue));
