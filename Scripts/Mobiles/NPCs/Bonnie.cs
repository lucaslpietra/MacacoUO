...
namespace Server.Items
{
    public class Trades : BaseCollectionMobile
    {
        ...
        public override void Init()
        {
            ...
            this.Donations.Add(new CollectionItem(typeof(BeriloIngot), 0x1BF2, 1074916, 0x973, 2));				
            this.Donations.Add(new CollectionItem(typeof(VibraniumIngot), 0x1BF2, 1074917, 0x966, 4));				
            ...
            this.Donations.Add(new CollectionItem(typeof(SilverIngot), 0x1BF2, 1074920, 0x8A5, 18));				
            this.Donations.Add(new CollectionItem(typeof(NiobioIngot), 0x1BF2, 1074921, 0x979, 24));				
            this.Donations.Add(new CollectionItem(typeof(LazuritaIngot), 0x1BF2, 1074922, 0x89F, 31));				
            this.Donations.Add(new CollectionItem(typeof(QuartzoIngot), 0x1BF2, 1074923, 0x8AB, 39));							
