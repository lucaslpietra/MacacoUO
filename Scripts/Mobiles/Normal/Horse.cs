...
namespace Server.Mobiles
{
    ...
    [CorpseName("a horse corpse")]
    public class SilverBullet : BaseMount
    {
        private static readonly int[] m_IDs = new int[]
        {
            0xC8, 0x3E9F,
        ...
        [Constructable]
        public SilverBullet(string name)
            : base(name, 0xE2, 0x3EA0, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            int random = Utility.Random(4);
        ...
        public SilverBullet(Serial serial)
            : base(serial)
        {
        }
    ...
    [CorpseName("a horse corpse")]
    public class GraniteMustang : BaseMount
    {
        private static readonly int[] m_IDs = new int[]
        {
            0xC8, 0x3E9F,
        ...
        [Constructable]
        public GraniteMustang()
            : this("mustang")
        {
        }

        [Constructable]
        public GraniteMustang(string name)
            : base(name, 0xE2, 0x3EA0, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            int random = Utility.Random(4);
        ...
        public GraniteMustang(Serial serial)
            : base(serial)
        {
        }
