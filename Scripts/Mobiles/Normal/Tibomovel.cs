...
namespace Server.Mobiles
{
    ...
    public class Tibomovel : BaseMount
    {
        [Constructable]
        public Tibomovel()
            : this("Tibomovel")
        ...
        [Constructable]
        public Tibomovel(string name)
            : base(name, 0xF6, 0x3A5F, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
        ...
        public Tibomovel(Serial serial)
            : base(serial)
        {
        }
