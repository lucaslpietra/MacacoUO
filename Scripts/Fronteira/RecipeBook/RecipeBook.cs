...
namespace Server.Items
{
    ...
    public class RecipeScrollDefinition
    {
        public static RecipeSkillName RecipeSkillNameConvert(SkillName n)
        {
            switch (n)
            {
                case SkillName.Alchemy: return RecipeSkillName.Alchemy;
                case SkillName.Blacksmith: return RecipeSkillName.Blacksmith;
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            else if (dropped is RecipeScroll)
            {
                ...
                if (Recipes.Any(x => x.RecipeID == recipe.RecipeID))
                {
                    ...
                    from.SendMessage("Adicionada receita no livro"); // Recipe added to the book.
