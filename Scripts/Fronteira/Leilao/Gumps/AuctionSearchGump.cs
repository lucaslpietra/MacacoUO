...
namespace Server.Leilaum
{
	...
	public class AuctionSearchGump : Gump
	{
		...
		private void MakeGump()
		{
			...
			AddLabel(185, 45, LUtils.kGreenHue, AuctionSystem.ST[ 32 ] );
			...
			AddLabel(295, 350, LUtils.kLabelHue, AuctionSystem.ST[ 16 ] );

			// BUTTON 0 : Cancel
			AddButton(85, 350, 4017, 4018, 0, GumpButtonType.Reply, 0);
			AddLabel(125, 350, LUtils.kLabelHue, AuctionSystem.ST[ 47 ] );
			
			// CHECK 0: Search withing existing results
			AddCheck(80, 310, 9721, 9724, false, 0);
			AddLabel(115, 312, LUtils.kLabelHue, AuctionSystem.ST[ 48 ] );
		}
