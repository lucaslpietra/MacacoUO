...
namespace Server.Leilaum
{
	...
	public class MyAuctionGump : Gump
	{
		...
		private void MakeGump()
		{
			...
			AddLabel(100, 130, LUtils.kLabelHue, AuctionSystem.ST[ 11 ] );
			AddLabel(285, 130, LUtils.kLabelHue, AuctionSystem.ST[ 12 ] );
			AddLabel(100, 165, LUtils.kLabelHue, AuctionSystem.ST[ 13 ] );
			...
			AddLabel(100, 205, LUtils.kLabelHue, AuctionSystem.ST[ 14 ] );
		...
		public override void OnResponse(Server.Network.NetState sender, RelayInfo info)
		{
			...
			switch( info.ButtonID )
			{
				...
				case 1: // View your auctions
					...
					sender.Mobile.SendGump( new AuctionListing( sender.Mobile, AuctionSystem.GetAuctions( sender.Mobile ), false, true ) );
					break;
