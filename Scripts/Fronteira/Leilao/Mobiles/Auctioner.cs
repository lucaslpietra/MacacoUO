...
namespace Server.Leilaum
{
	...
	public class Auctioner : BaseVendor
	{
		...
		[ Constructable ]
		public Auctioner() : base ( "o leiloeiro" )
		{
			RangePerception = 10;
		}
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                SayTo(from, "Desculpe estamos fechados.");
            }
        }

        public override void OnSpeech(SpeechEventArgs e)
		{
			if ( e.Speech.ToLower().IndexOf( "leilao" ) > -1 )
			{
				e.Handled = true;

				if ( ! e.Mobile.CheckAlive() )
				{
					SayTo( e.Mobile, "Estou ouvindo vozes ?" );
				}
				...
				{
					SayTo( e.Mobile, "Desculpe estamos fechados." );
				}
			}
