...
namespace Server.Items
{
    public static class EnchantedHotItem
    {
        ...
        {
            new Point3D(5703, 664, 0),
            new Point3D(5703, 663, 0), new Point3D(5703, 662, 0), new Point3D(5703, 661, 0),
    ...
    public class HotItemChest : LockableContainer
    {
        ...
        public void SpawnLoot()
        {
            ...
            {
                var chest = new MetalGoldenChest();
                chest.Hue = 2753;
                chest.Name = "Bau Ornamentado";
                DropItem(chest);
            }
            ...
            for (int i = 0; i < toSpawn; i++)
            {
                ...
                else
                {
                    ...
                    {
                        item = Loot.RandomArmorOrShieldOrWeaponOrJewelry(false, false, false);
                    }
                ...
                if (Utility.RandomDouble() < 0.3)
                {
                    ...
                    if(Utility.RandomBool())
                        deco = new BlanketOfDarkness();
                    else
                    {
                        deco = new TortureRackEastDeed();
                    }
                    deco.Hue = 1258;
                    deco.AttachSocket(new EnchantedHotItemSocket(this));
                    DropItem(deco);
                }
                ...
                {
                    var wand = new IDWand();
                    wand.Charges = 5 + Utility.Random(20);
                    wand.AttachSocket(new EnchantedHotItemSocket(this));
                    wand.Hue = 1258;
                    DropItem(wand);
                }
