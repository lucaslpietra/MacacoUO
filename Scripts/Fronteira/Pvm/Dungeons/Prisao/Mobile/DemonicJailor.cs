...
{ 
    ...
    { 
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 15, 1, 0.1, 0.3)
        {
            ...
            this.Title = "o carcereiro malogro";
            this.Hue = 34531;
            this.Body = 0x190;
        ...
        public override void OnGaveMeleeAttack(Mobile defender)
        {
            ...
            defender.OverheadMessage("Voce foi capturado pelo carcereiro e foi colocado em uma cela"); // You are captured by the jailor and returned to your cell.
        }
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            ...
            base.OnMovement(m, oldLocation);
               ...
               if (m_NextTerror < DateTime.Now && m != null && InRange(m.Location, 3) && m.AccessLevel <= AccessLevel.VIP)
            {
                m.Frozen = true;
                m.SendMessage(38, "O terror toma conta de sua mente e voce paraliza de medo"); // Terror slices into your very being, destroying any chance of resisting ~1_name~ you might have had
                m.OverheadMessage("* Aterrorizado *");
