        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                if (Utility.RandomDouble() < 0.5)
                {
                    ...
                    this.PrivateMessage("Disparou uma armadilha ", from); // You set off a trap!
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        from.SendLocalizedMessage("Voce desfez a cama mas nao achou nada"); //You tear the bedroll to pieces but find nothing.
                    }
                }
            }
