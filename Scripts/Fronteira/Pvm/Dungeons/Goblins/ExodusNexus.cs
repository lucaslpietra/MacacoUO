...
{
    public class ExodusNexus : NexusAddon2
    {
        ...
        {
            to.SendMessage("O nexus descarga uma corrente eletrica"); // The Nexus shoots an arc of energy at you! 
            to.BoltEffect(0);
            to.OverheadMessage("* em choque *");
            ...
            AOS.Damage(to, to, 30, 0, 0, 0, 0, 100);
        ...
        public void Solve(Mobile from)
        {
            ...
            from.SendMessage("Voce conseguiu reparar o nexus ! Um cartao foi cuspido !"); // You repair the mysterious Nexus! As it whirs to life it spits out a punch card! 
        ...
        public class DamageTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                m_To.OverheadMessage("* em choque *");
                ...
                AOS.Damage(this.m_To, this.m_To, 10, 0, 0, 0, 0, 100);
        ...
        public class NexusGameGump : Gump
        {
                ...
                : base(5, 30)
            {
                ...
                this.AddHtml(165, 35, 300, 45, "<center>Painel de Controle do Gerador</center>", false, false); // <center>GENERATOR CONTROL nexus</center>
                this.AddHtml(165, 60, 300, 70, "<center>Use os direcionais para caminhar</center>", false, false); // <center>Use the Directional Controls to</center>
                this.AddHtml(165, 75, 300, 85, "<center>Feche o circuito</center>", false, false); // <center>Close the Grid Circuit</center>
                ...
                if (from.Skills.Lockpicking.Value >= 65.0)
                {
                    ...
                    this.AddHtml(405, 345, 140, 40, "Tentar Decifrar (Lockpicking)", false, false); // Attempt to Decipher the Circuit Path
                }
            }
