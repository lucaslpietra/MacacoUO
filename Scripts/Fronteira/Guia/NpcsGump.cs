...
namespace Server.Items
{
    public class NPCSGump : Gump
    {
        ...
        public bool CheckFilter(BaseVendor recipe)
        {
            ...
            {
                if (recipe.Region != null && recipe.Region.Name != null && recipe.Region.Name.Contains(filtro))
                {
                    return true;
                }
            }
            ...
            : base(12, 24)
        {
            ...
            if (list == null)
            {
                ...
                {
                    if (vendor.Map == Map.Felucca && vendor.Region == null || !(vendor.Region is DungeonRegion))
                    {
                        list.Add(vendor);
                    }
                }
