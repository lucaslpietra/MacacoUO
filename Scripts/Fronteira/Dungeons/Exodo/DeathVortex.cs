...
namespace Server.Items
{
    public class DeathVortexTrap : BaseTrap
    {
        ...
        public void StamManaDrain(Mobile defender)
        {
                ...
                case 0:
                    {
                        if (defender.Alive)
                        {
                            int manaToLeech = (int)(defender.Mana * 0.2); // defender loses 1/2 of their mana
                ...
                case 1:
                    {
                        if (defender.Alive)
                        {
                            int stamToLeech = (int)(defender.Stam * 0.2); // defender loses 9/10 of their stamina
            ...
            defender.SendMessage("Voce sente sua energia sendo sugada"); // Your life force is drained by the death vortex! 
        }
