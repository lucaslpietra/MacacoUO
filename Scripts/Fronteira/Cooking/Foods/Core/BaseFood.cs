...
namespace Server.Items
{
    public abstract class BaseFood : Item
    {
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            if (m_Skill != null)
                list.Add("+"+SkillBoost+" "+Skill);
            if (IntBoost > 0)
                list.Add("+" + IntBoost+" Int");
            if (DexBoost > 0)
                list.Add("+" + DexBoost + " Dex");
            if (StrBoost > 0)
                list.Add("+" + StrBoost + " Str");
        }
        ...
        public virtual bool Eat(Mobile from)
        {
            ...
            if (this.CheckHunger(from))
            {
                ...
                if (this.m_Raw == true)
                {
                    ...
                    {
                        case 0: from.SendMessage("A comida estava muito crua e voce nao se sente muito bem!");  from.Poison = Poison.Regular; break;
                        case 1: from.SendMessage("A comida estava muito crua e voce nao se sente muito bem!");  from.Poison = Poison.Lesser; break;
                        case 2: from.SendMessage("A comida estava muito crua e voce nao se sente muito bem!");  from.Poison = Poison.Greater; break;
                        case 3: from.SendMessage("A comida estava muito crua, teve sorte de nao passar mal"); break;
                        case 4: from.SendMessage("A comida estava muito crua e voce nao se sente muito bem!");  from.Poison = Poison.Deadly; break;
                        case 5: from.SendMessage("A comida estava muito crua, teve sorte de nao passar mal"); break;
                        case 6: from.SendMessage("A comida estava muito crua e voce nao se sente muito bem!");  from.Poison = Poison.Regular; break;
                        default: break;
                    }
                }
                #endregion
                ...
                if (Rotten == true)
                {
                    ...
                    {
                        case 0: pm.SendMessage("A comida estava podre e voce nao se sente muito bem!");  pm.Poison = Poison.Regular; break;
                        case 1: pm.SendMessage("A comida estava podre e voce nao se sente muito bem!");  pm.Poison = Poison.Lesser; break;
                        case 2: pm.SendMessage("A comida estava podre e voce nao se sente muito bem!");  pm.Hits -= 10; break;
                        case 3: pm.SendMessage("A comida estava podre e voce nao se sente muito bem!");  pm.Mana -= 10; break;
                        case 4: pm.SendMessage("A comida estava podre e voce nao se sente muito bem!");  pm.Poison = Poison.Greater; break;
                        case 5: pm.SendMessage("A comida estava podre, teve sorte de nao passar mal"); break;
                        case 6: pm.SendMessage("A comida estava podre e voce nao se sente muito bem!");  pm.Poison = Poison.Deadly; break;
                        case 7: pm.SendMessage("A comida estava podre e voce nao se sente muito bem!"); pm.Hunger -= 10; break;
                        case 8: pm.SendMessage("A comida estava podre, teve sorte de nao passar mal"); break;
                        case 9: pm.SendMessage("A comida estava podre e voce nao se sente muito bem!");  pm.Poison = Poison.Regular; break;
                        case 10: pm.SendMessage("A comida estava podre e voce nao se sente muito bem!"); pm.Hunger -= 10; break;
                        case 11: pm.SendMessage("A comida estava podre e voce nao se sente muito bem!");  pm.Stam -= 10; break;
                        default: break;
                    }
                }
                #endregion
                ...
                if (m_Skill != null)
                {
                    ...
                    {
                        from.SendMessage(521, "Voce ja tem um efeito em {0}.", m_Skill);
                    }
                }
                ...
                if (IntBoost > 0)
                {
                    ...
                    {
                        from.SendMessage(521, "Voce ja esta sobre um efeito de Int.");
                    }
                }
                if (DexBoost > 0)
                {
                    ...
                    {
                        from.SendMessage(521, "Voce ja esta sobre um efeito de Dex.");
                    }
                }
                if (StrBoost > 0)
                {
                    ...
                    {
                        from.SendMessage(521, "Voce ja esta sobre um efeito de Str.");
                    }
                }
                #endregion
        ...
        public static bool FillHunger(Mobile from, int fillFactor)
        {
            if (from.Hunger >= 20)
            {
                from.SendMessage("Nao cabe mais nada nesse barrigao"); // You are simply too full to eat any more!
                return false;
            }
