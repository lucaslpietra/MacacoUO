...
namespace Server.Engines.Craft
{
    ...
    public class DefBeerBrewing : CraftSystem
	{
        ...
        public override string GumpTitleString { get { return "<basefont color=#FFFFFF><CENTER>Cervejas</CENTER></basefont>"; } }
		...
		{
			int index = -1;
			string skillNotice = "Voce nao faz ideia como fazer isto.";
