...
namespace Server.Items
{
	public class MushroomAddon : AddonComponent
	{
		...
		{
			from.SendMessage( "Os cogumelos desfazem. Voce precisa adicionar sementes de cogumelo no jardim." ); 
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			if ( from.Mounted )
			{
				from.SendMessage( "Voce nao consegue alcansar, talvez seja melhor desmontar." ); 
				return; 
			}
			...
			{ 
				if ( m_yield < 1 )
				{
					from.SendMessage( "Nada aqui para colher." ); 
				...
				{
					from.SendMessage( "Voce nao encontrou nenhum cogumelo." );
				}
			}
		}
