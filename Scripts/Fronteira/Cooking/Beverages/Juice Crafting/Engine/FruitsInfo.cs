...
namespace Server.Items
{
	...
	public class JuicingResources
	{
		...
		{
			new FruitsVarietyInfo( 0x0, 0,	"Maca",		FruitsVariety.Apple,		typeof( Apple ) ),
			...
			new FruitsVarietyInfo( 0x0, 0,	"Uva",		FruitsVariety.Grapes,	typeof( Grapes ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Limao",		FruitsVariety.Lemon,	typeof( Lemon ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Lima",		FruitsVariety.Lime,		typeof( Lime ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Laranja",		FruitsVariety.Orange,	typeof( Orange ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Pessego",		FruitsVariety.Peach,		typeof( Peach ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Pera",		FruitsVariety.Pear,		typeof( Pear ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Abobora",	FruitsVariety.Pumpkin,	typeof( Pumpkin ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Tomate",		FruitsVariety.Tomato,	typeof( Tomato ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Melao",	FruitsVariety.Watermelon,	typeof( Watermelon ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Damasco",		FruitsVariety.Apricot,	typeof( Apricot ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Amora",	FruitsVariety.Blackberry,	typeof( Blackberry ) ),
			new FruitsVarietyInfo( 0x0, 0,  "Mirtilo",	FruitsVariety.Blueberry,	typeof( Blueberry ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Cereja",		FruitsVariety.Cherry,		typeof( Cherry ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Oxicoco",	FruitsVariety.Cranberry,	typeof( Cranberry ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Toranja",	FruitsVariety.Grapefruit,	typeof( Grapefruit ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Kiwi",		FruitsVariety.Kiwi,		typeof( Kiwi ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Manga",		FruitsVariety.Mango,	typeof( Mango ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Abacaxi",	FruitsVariety.Pineapple,	typeof( Pineapple ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Roma",	FruitsVariety.Pomegranate,	typeof( Pomegranate ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Morango",	FruitsVariety.Strawberry,	typeof( Strawberry ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Amendoa",		FruitsVariety.Almond,	typeof( Almond ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Asparagus",	FruitsVariety.Asparagus,	typeof( Asparagus ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Abacate",	FruitsVariety.Avocado,	typeof( Avocado ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Beterraba",		FruitsVariety.Beet,		typeof( Beet ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Framboesa",	FruitsVariety.BlackRaspberry,	typeof( BlackRaspberry ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Cantaloupe",	FruitsVariety.Cantaloupe,	typeof( Cantaloupe ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Cenoura",		FruitsVariety.Carrot,		typeof( Carrot ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Couve-Flor",	FruitsVariety.Cauliflower,	typeof( Cauliflower ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Salsinha",		FruitsVariety.Celery,		typeof( Celery ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Coco",	FruitsVariety.Coconut,	typeof( Coconut ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Milho",		FruitsVariety.Corn,		typeof( Corn ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Pepino",	FruitsVariety.Cucumber,	typeof( Cucumber ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Abobrinha",	FruitsVariety.GreenSquash,	typeof( GreenSquash ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Melao",	FruitsVariety.HoneydewMelon,	typeof( HoneydewMelon ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Cebola",		FruitsVariety.Onion,		typeof( Onion ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Amendoim",		FruitsVariety.Peanut,	typeof( Peanut ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Pistacio",	FruitsVariety.Pistacio,	typeof( Pistacio ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Batata",		FruitsVariety.Potato,		typeof( Potato ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Repolho",		FruitsVariety.Radish,	typeof( Radish ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Framboesa Vermelha",	FruitsVariety.RedRaspberry,	typeof( RedRaspberry ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Espinafre",	FruitsVariety.Spinach,	typeof( Spinach ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Abobrinha",		FruitsVariety.Squash,	typeof( Squash ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Batata Doce",	FruitsVariety.SweetPotato,	typeof( SweetPotato ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Rabanete",		FruitsVariety.Turnip,		typeof( Turnip ) )
		};
	...
	{
		public static readonly FruitsInfo BitterFruits = new FruitsInfo( 0, 0x000, "Frutas Amargas" );
		public static readonly FruitsInfo SnowFruits = new FruitsInfo( 1, 0x481, "Frutas Nevadas" );
		public static readonly FruitsInfo ElvenFruits = new FruitsInfo( 2, 0x17, "Frutas Elficas" );
		public static readonly FruitsInfo SweetFruits = new FruitsInfo( 3, 0x30, "Frutas Doces" );
