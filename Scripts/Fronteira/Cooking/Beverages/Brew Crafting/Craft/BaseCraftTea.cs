	...
	public abstract class BaseCraftTea : Item, ICraftable
	{
		...
		public override void AddNameProperties( ObjectPropertyList list )
 		{
			...
			if ( m_Quality == TeaQuality.Exceptional ) list.Add( "Reserve Cha Verde " );
 			else list.Add( "Cha Verde" );
 		}
		...
		public override void OnSingleClick( Mobile from )
		{
			if (this.Name == null )
			{
				...
				else this.LabelTo( from, "Cha Verde" );
			}
			else this.LabelTo( from, "{0}", this.Name );
			if ( m_Quality == TeaQuality.Exceptional ) this.LabelTo( from, "Reserve Cha Verde" );
 			else this.LabelTo( from, "Cha Verde" );
		}
