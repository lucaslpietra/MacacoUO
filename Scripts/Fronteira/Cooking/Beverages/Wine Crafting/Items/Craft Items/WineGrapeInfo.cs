...
namespace Server.Items
{
	...
	public class WinemakingResources
	{
		private static GrapeVarietyInfo[] m_GrapeInfo = new GrapeVarietyInfo[]
		{
			...
			new GrapeVarietyInfo( 0x000, 0,	"Maca",			GrapeVariety.Apple,			typeof( Apple ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Apricot",			GrapeVariety.Apricot,		typeof( Apricot ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Cereja",			GrapeVariety.Cherry,		typeof( Cherry ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Manga",			GrapeVariety.Mango,		typeof( Mango ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Laranja",			GrapeVariety.Orange,		typeof( Orange ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Pera",			GrapeVariety.Pear,			typeof( Pear ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Pessego",			GrapeVariety.Peach,		typeof( Peach ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Amora",		GrapeVariety.Blackberry,		typeof( Blackberry ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Framboesa",		GrapeVariety.BlackRaspberry,		typeof( BlackRaspberry ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Mirtilo",		GrapeVariety.Blueberry,		typeof( Blueberry ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Oxicoco",		GrapeVariety.Cranberry,		typeof( Cranberry ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Framboesa Vermelha",		GrapeVariety.RedRaspberry,		typeof( RedRaspberry ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Morango",		GrapeVariety.Strawberry,		typeof( Strawberry ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Melancia",		GrapeVariety.Watermelon,		typeof( Watermelon ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Arroz",			GrapeVariety.Rice,			typeof( RiceSheath ) ),
			new GrapeVarietyInfo( 0x000, 0,	"Dente de leao",		GrapeVariety.Dandelion,		typeof( Dandelion ) )
		};
	...
	public class WineGrapeInfo
	{
		...
		public static readonly WineGrapeInfo Apple		= new WineGrapeInfo( 11, 0x000, "Maca" );
		public static readonly WineGrapeInfo Apricot		= new WineGrapeInfo( 12, 0x000, "Apricot" );
		public static readonly WineGrapeInfo Cherry		= new WineGrapeInfo( 13, 0x000, "Cereja" );
		public static readonly WineGrapeInfo Mango		= new WineGrapeInfo( 14, 0x000, "Manga" );
		public static readonly WineGrapeInfo Orange		= new WineGrapeInfo( 15, 0x000, "Laranja" );
		public static readonly WineGrapeInfo Pear		= new WineGrapeInfo( 16, 0x000, "Pera" );
		public static readonly WineGrapeInfo Peach		= new WineGrapeInfo( 17, 0x000, "Pessego" );
		public static readonly WineGrapeInfo Blackberry		= new WineGrapeInfo( 18, 0x000, "Amora" );
		public static readonly WineGrapeInfo BlackRaspberry	= new WineGrapeInfo( 19, 0x000, "Framboesa" );
		public static readonly WineGrapeInfo Blueberry		= new WineGrapeInfo( 20, 0x000, "Itilo" );
		public static readonly WineGrapeInfo Cranberry		= new WineGrapeInfo( 21, 0x000, "Oxicoco" );
		public static readonly WineGrapeInfo RedRaspberry		= new WineGrapeInfo( 22, 0x000, "Framboesa Vermelha" );
		public static readonly WineGrapeInfo Strawberry		= new WineGrapeInfo( 23, 0x000, "Morango" );
		public static readonly WineGrapeInfo Watermelon		= new WineGrapeInfo( 24, 0x000, "Melancia" );
		public static readonly WineGrapeInfo Rice		= new WineGrapeInfo( 25, 0x000, "Arroz" );
		public static readonly WineGrapeInfo Dandelion		= new WineGrapeInfo( 25, 0x000, "Dente de leao" );
