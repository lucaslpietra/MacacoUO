...
namespace Server.Engines.TexasHoldem
{
    ...
    public partial class Hand : IComparable
    {
       ...
       /// <returns></returns>
        public static string DescriptionFromMask(ulong cards)
        {
            ...
            switch ((HandTypes)HandType(handvalue))
            {
                ...
                case HandTypes.Flush:
                    if (nBitsTable[ss] >= 5)
                    {
                        return "Flush (Espadas) com " + ranktbl[TopCard(handvalue)] + " alta";
                    }
                    else if (nBitsTable[sc] >= 5)
                    {
                        return "Flush (Paus) com " + ranktbl[TopCard(handvalue)] + " alta";
                    }
                    else if (nBitsTable[sd] >= 5)
                    {
                        return "Flush (Ouros) com " + ranktbl[TopCard(handvalue)] + " alta";
                    }
                    else if (nBitsTable[sh] >= 5)
                    {
                        return "Flush (Copas) com " + ranktbl[TopCard(handvalue)] + " alta";
                    }
                    break;
                case HandTypes.StraightFlush:
                    if (nBitsTable[ss] >= 5)
                    {
                        return "Straight Flush (Espadas) com " + ranktbl[TopCard(handvalue)] + " high";
                    }
                    else if (nBitsTable[sc] >= 5)
                    {
                        return "Straight (Paus) com " + ranktbl[TopCard(handvalue)] + " high";
                    }
                    else if (nBitsTable[sd] >= 5)
                    {
                        return "Straight (Ouros) com " + ranktbl[TopCard(handvalue)] + " high";
                    }
                    else if (nBitsTable[sh] >= 5)
                    {
                        return "Straight  (Copas) com " + ranktbl[TopCard(handvalue)] + " high";
                    }
                    break;
            }
            Debug.Assert(false); // Should never get here
		...
		{
			"Dois", "Tre", "Quatro", "Cinco", "Seis", "Sete", "Oito", "Nove", "Dez", "Valete", "Dama", "Rei", "As",
            "Dois", "Tre", "Quatro", "Cinco", "Seis", "Sete", "Oito", "Nove", "Dez", "Valete", "Dama", "Rei", "As",
            "Dois", "Tre", "Quatro", "Cinco", "Seis", "Sete", "Oito", "Nove", "Dez", "Valete", "Dama", "Rei", "As",
            "Dois", "Tre", "Quatro", "Cinco", "Seis", "Sete", "Oito", "Nove", "Dez", "Valete", "Dama", "Rei", "As",
        };
		...
		{
			"Paus", "Paus", "Paus", "Paus", "Paus", "Paus", "Paus", "Paus", "Paus", "Paus", "Paus", "Paus", "Paus",
			"Ouros", "Ouros", "Ouros", "Ouros", "Ouros", "Ouros", "Ouros", "Ouros", "Ouros", "Ouros", "Ouros", "Ouros", "Ouros",
			"Copas", "Copas", "Copas", "Copas", "Copas", "Copas", "Copas", "Copas", "Copas", "Copas", "Copas", "Copas", "Copas",
			"Espadas", "Espadas", "Espadas", "Espadas", "Espadas", "Espadas", "Espadas", "Espadas", "Espadas", "Espadas", "Espadas", "Espadas", "Espadas",
		};
