...
namespace Server.Engines.ResortAndCasino
{
    ...
    public class PurchaseCasinoChipGump : Gump
    {
        ...
        public void AddGumpLayout()
        {
            ...
            switch (this.Section)
            {
                case Section.None:
                    ...
                    if (Bought > 0 || CashedOut > 0)
                    {
                        ...
                        AddHtml(20, y, 200, 16, "Sucesso", false, false); // Transaction successful:
                        y += 20;
                    ...
                    AddHtmlLocalized(20, y, 200, 16, "Seu Saldo no Banco", false, false); // Your Bank Balance:
                    AddHtml(300, y, 150, 16, Color("#FF69B4", total.ToString("N0", CultureInfo.GetCultureInfo("en-US"))), false, false);
                    y += 20;

                    AddHtmlLocalized(20, y, 200, 16, "Suas Fichas", false, false); // Your Chip Balance:
                    AddHtml(300, y, 150, 16, Color("#FF69B4", chips.ToString("N0", CultureInfo.GetCultureInfo("en-US"))), false, false);
                    y += 30;

                    AddHtmlLocalized(20, y, 200, 16, "Comprar Fichas", false, false); // Buy Chips
                    AddButton(300, y, 4014, 4016, 1, GumpButtonType.Reply, 0);

                    y += 20;

                    AddHtmlLocalized(20, y, 200, 16, "Trocar suas fichas", false, false); // Cash Out
                    AddButton(300, y, 4014, 4016, 2, GumpButtonType.Reply, 0);

                    break;
                case Section.Buying:
                    AddHtml(20, 50, 180, 16, "Cada ficha custa 100gp", false, false); // Each casino chip costs 100gp
                    AddHtml(20, 80, 180, 16, "Numero de fichas para comprar", false, false); // Number of chips to buy:

                    AddBackground(215, 80, 200, 20, 9350);
                    AddTextEntry(216, 80, 199, 20, 0, 0, "");
                    AddButton(215, 110, 4005, 4007, 3, GumpButtonType.Reply, 0);
                    AddHtmlLocalized(20, 110, 150, 16, "Comprar Fichas", false, false);
                    break;
                case Section.Selling:
                    AddHtml(20, 50, 180, 16, "Voce recebe 100gp por ficha", false, false); // You will receive 100gp for each chip
                    AddHtml(20, 80, 180, 16, "Fichas para vender", false, false); // Number of chips to cash out:
                    AddBackground(215, 80, 200, 20, 9350);
                    AddTextEntry(216, 80, 199, 20, 0, 1, "");
                    AddButton(215, 110, 4005, 4007, 4, GumpButtonType.Reply, 0);
                    AddHtml(20, 110, 150, 16, "Vender Fichas", false, false); // CASH OUT
                    break;
                case Section.Error:
                    AddHtml(20, 50, 390, 40, "Houve um problema...", false, false); // There was a problem completing your transaction:
            ...
            if (this.Section == Section.None)
            {
                ...
                AddHtml(55, 193, 150, 16, Color("#FFFF00", "FECHAR"), false, false);
            }
            else
            {
                AddButton(15, 195, 4005, 4007, 5, GumpButtonType.Reply, 0);
                AddHtml(55, 193, 150, 16, Color("#FFFF00", "VOLTAR"), false, false);
            }
        }
    ...
    public class BaseCasinoGump : Gump
    {
        ...
        public virtual void AddGumpLayout()
        {
            ...
            if (Title != null)
                AddHtml(15, 20, Width - 30, 16, Color(Yellow+"", Title), false, false);

            if (PointsSystem.CasinoData.GetPoints(User) <= 0)
                AddHtml(15, 150, Width - 30, 40, "Voce nao tem fichas, compre fichas no caixa.", false, false); // You have no chips to bet with. Please visit the Casino Cashier to buy chips.
            else
            {
        ...
        {
            AddHtmlLocalized(20, 170, 240, 32, "Aposta invalida", false, false); // Invalid bet amount entered

            AddButton(15, Height - 35, 4005, 4007, 250, GumpButtonType.Reply, 0);

            AddHtml(55, Height - 32, 150, 16, "Continuar", false, false);
            DiceGame.Remove();
        }
    ...
    {
        public override string Title { get { return "Sorte do Dado"; } } // CHUCKLES' LUCK
        ...
        public override void AddGumpLayout()
        {
            ...
            AddHtmlLocalized(15, 50, Width - 30, 80, "Coloque uma aposta em qualquer numero de 1 a 6 e 3 dados vao rolar. Voce ganha sua aposta para cada dado que cair em seu numero.", false, false); // Place a bet on any number. The dealer will roll three dice. Win back your bet times the number of times your lucky number comes up!
        }
        ...
        public override void BuildBetting()
        {
            ...
            AddHtmlLocalized(20, 140, 240, 16, "Voce tem "+ chips.ToString(CultureInfo.GetCultureInfo("en-US"))+" fichas", false, false); // You have ~1_VAL~ chips

            AddHtmlLocalized(20, 170, 240, 40, "Entre o valor de sua aposta abaixo", false, false); // Enter your bet below and click the die showing your lucky number!
            AddHtmlLocalized(20, 230, 240, 16, "Valor da aposta:", false, false); // Amount to bet:
            ...
            AddHtml(55, 293, 150, 16, Color("#FFFF00", "FECHAR"), false, false);
        }

        public override void BuildRolling()
        {
            AddHtmlLocalized(0, 140, 138, 16, "Valor da aposta", false, false); // Amount of Bet:
            AddHtml(142, 140, 150, 16, Color("#FFFF00", Game.CurrentBet.ToString(CultureInfo.GetCultureInfo("en-US"))), false, false);

            AddHtmlLocalized(0, 160, 138, 16, "Apostado:", false, false);  // Betting On:
            AddHtml(142, 160, 150, 16, Color("#FFFF00", Game.BettingOn.ToString()), false, false);

            AddHtmlLocalized(15, 190, Width - 30, 40, "O dealer prepara para rolar os dados..", false, false);  // The dealer prepares to roll the dice...
        }
        ...
        public override void BuildResults()
        {
            ...
            AddHtmlLocalized(0, 140, 138, 16,"Aposta:", false, false); // Amount of Bet:
            AddHtml(142, 140, 150, 16, Color("#FFFF00", Game.CurrentBet.ToString(CultureInfo.GetCultureInfo("en-US"))), false, false);

            AddHtmlLocalized(0, 160, 138, 16, "Apostando em:", false, false);  // Betting On:
            AddHtml(142, 160, 150, 16, Color("#FFFF00", Game.BettingOn.ToString()), false, false);

            AddHtmlLocalized(15, 190, 138, 16,"O Dealer rolou:", false, false);  // The dealer rolls:
            ...
            if (!Game.Winner)
                AddHtmlLocalized(20, 250, 240, 32, "Nao caiu seu numero, voce perdeu "+ Game.CurrentBet.ToString(CultureInfo.GetCultureInfo("en-US")), false, false); // The dice did not match your number. You lose your bet of ~1_AMT~.
            else
            {
                int matches = Game.GetMatches();
                int win = Game.CurrentBet * matches;

                AddHtmlLocalized(20, 250, 240, 32, String.Format("{0} dados cairam seu numero e voce ganhou \t{1}", matches.ToString(), win.ToString(CultureInfo.GetCultureInfo("en-US"))), false, false); // The dice matched your number ~1_COUNT~ times. You win ~2_AMT~ chips!
            }

            AddHtml(55, 293, 150, 16, Color("#FFFF00", Game.Winner ? "COLETAR" : "CONTINUAR"), false, false);
    ...
    {
        public override string Title { get { return "Hi Midle Lo"; } } // HI-MIDDLE-LO
        ...
        public override void AddGumpLayout()
        {
            ...
            AddHtmlLocalized(15, 50, Width - 30, 90, "Coloque uma aposta em low middle high ou outside. O dealer rola 3 dados e a casa sempre ganha se cair 3 iguais. High ganha com 11 ou mais, low 10 ou menos mid de 9 a 12.", false, true);
        ...
        public override void BuildBetting()
        {
            ...
            AddHtmlLocalized(15, 145, 340, 16, "Voce tem em fichas:"+ chips.ToString(CultureInfo.GetCultureInfo("en-US")), false, false); // You have ~1_VAL~ chips
            AddHtmlLocalized(15, 175, 340, 40, "Escolha sua aposta:", false, false); // Enter your wager here and select which way you wish to bet:

            AddHtmlLocalized(15, 220, 300, 16, "Quantidade:", false, false); // Amount to bet:
            ...
            AddHtml(55, 347, 150, 16, Color("#FFFF00", "FECHAR"), false, false);
        }

        public override void BuildRolling()
        {
            AddHtmlLocalized(0, 145, 188, 16, "Aposta:", false, false); // Amount of Bet:
            AddHtml(192, 145, 150, 16, Color("#FFFF00", Game.CurrentBet.ToString(CultureInfo.GetCultureInfo("en-US"))), false, false);

            AddHtmlLocalized(0, 165, 188, 16,"Apostando em:", false, false);  // Betting On:
            AddHtml(192, 165, 150, 16, Color("#FFFF00", ((HighMiddleLowType)Game.BettingOn).ToString()), false, false);

            AddHtmlLocalized(15, 195, Width - 30, 40, "O Dealer prepara para rolar os dados", false, false);  // The dealer prepares to roll the dice...
        }
        ...
        public override void BuildResults()
        {
            ...
            AddHtmlLocalized(0, 245, 188, 16, "Quantidade da aposta:", false, false); // Amount of Bet:
            AddHtml(192, 245, 188, 16, Color("#FFFF00", Game.CurrentBet.ToString(CultureInfo.GetCultureInfo("en-US"))), false, false);

            AddHtmlLocalized(0, 265, 188, 16, "Apostando em", false, false);  // Betting On:
            ...
            if (!Game.Winner)
            {
                ...
                {
                    AddHtmlLocalized(20, 295, 340, 16, "Opa tres iguais, a casa ganhou", false, false);
                    y += 30;
                }

                AddHtmlLocalized(20, y, 345, 16, "Voce perdeu "+ Game.CurrentBet.ToString(CultureInfo.GetCultureInfo("en-US")), false, false); // You lost ~1_AMT~ chips. Better luck next time!
            }
            else
            {
                int winnings = Game.BettingOn == 4 ? Game.CurrentBet * 6 : Game.CurrentBet * 2;
                AddHtmlLocalized(20, 295, 340, 16, "Voce ganhou "+ winnings.ToString(CultureInfo.GetCultureInfo("en-US")), false, false); // You won ~1_AMT~ chips!
            }

            AddHtml(55, 347, 150, 16, Color("#FFFF00", Game.Winner ? "COLETAR" : "CONTINUAR"), false, false);
    ...
    {
        public override string Title { get { return "Doido dos Dados"; } } // DICE RIDER
        ...
        public override void BuildBetting()
        {
            ...
            AddHtml(55, Height - 35, 150, 16, Color("#FFFF00", "FECHAR"), false, false);
        }
