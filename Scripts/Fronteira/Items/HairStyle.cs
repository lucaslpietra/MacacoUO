...
{
    public class AdvancedHairRestylingDeed : Item
    {
        [Constructable]
        public AdvancedHairRestylingDeed()
            : base(0x14F0)
        {
            this.Weight = 1.0;
            this.LootType = LootType.Blessed;
            this.Name = "Cabelos Normais";
        }

        public AdvancedHairRestylingDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        private class InternalHumanBaseGump : Gump
        {
            private readonly Mobile m_From;
            private readonly AdvancedHairRestylingDeed m_Deed;
            /* 
            ...
            */
            ...
            public InternalHumanBaseGump(Mobile from, AdvancedHairRestylingDeed deed)
                : base(50, 50)
            {
                this.m_From = from;
                this.m_Deed = deed;
        ...
        private class InternalElvenBaseGump : Gump
        {
            private readonly Mobile m_From;
            private readonly AdvancedHairRestylingDeed m_Deed;
            /* 
            ...
            */
            ...
            public InternalElvenBaseGump(Mobile from, AdvancedHairRestylingDeed deed)
                : base(50, 50)
            {
                this.m_From = from;
                this.m_Deed = deed;
        ...
        private class InternalGargoyleBaseGump : Gump
        {
            private readonly Mobile m_From;
            private readonly AdvancedHairRestylingDeed m_Deed;
            /* 
            ...
            */
            ...
            public InternalGargoyleBaseGump(Mobile from, AdvancedHairRestylingDeed deed)
                : base(50, 50)
            {
                this.m_From = from;
                this.m_Deed = deed;
    ...
    public class AdvancedHairRestylingElfDeed : Item
    {
        [Constructable]
        public AdvancedHairRestylingElfDeed()
            : base(0x14F0)
        {
            this.Weight = 1.0;
            this.LootType = LootType.Blessed;
            this.Name = "Cabelos Elficos";
        }

        public AdvancedHairRestylingElfDeed(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            private readonly Mobile m_From;
            private readonly AdvancedHairRestylingElfDeed m_Deed;
            /* 
            gump data: bgX, bgY, htmlX, htmlY, imgX, imgY, butX, butY 
            */
            readonly int[][] LayoutArray =
            ...
            */
            ...
            public InternalHumanBaseGump(Mobile from, AdvancedHairRestylingElfDeed deed)
                : base(50, 50)
            {
                this.m_From = from;
                this.m_Deed = deed;
        ...
        private class InternalElvenBaseGump : Gump
        {
            ...
            */
            ...
            public InternalElvenBaseGump(Mobile from, AdvancedHairRestylingElfDeed deed)
                : base(50, 50)
            {
                this.m_From = from;
                this.m_Deed = deed;
        ...
        private class InternalGargoyleBaseGump : Gump
        {
            ...
            */
            ...
            public InternalGargoyleBaseGump(Mobile from, AdvancedHairRestylingElfDeed deed)
                : base(50, 50)
            {
                this.m_From = from;
                this.m_Deed = deed;
