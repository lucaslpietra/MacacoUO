...
namespace Server.Multis
{
    public class EvilMageCamp : BaseCamp
    {
        ...
        public override TimeSpan DecayDelay { get { return TimeSpan.FromMinutes(60); } }
        ...
        public override void AddComponents()
        {
            ...
            // some mages
            for (int i = 0; i < 3; i++)
                AddMobile(new EvilMage(), Utility.Random(-7, 15), Utility.Random(-7, 15), 0);

            // some mage lords
            for (int i = 0; i < 3; i++)
                AddMobile(new EvilMageLord(), Utility.Random(-7, 15), Utility.Random(-7, 15), 0);
