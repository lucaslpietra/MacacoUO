...
{
    [CorpseName("a mustang vibranium corpse")]
    [TypeAlias("Server.Mobiles.GrayHorse")]
    public class VibraniumMustang  : BaseMount
    {
        [Constructable]
        public VibraniumMustang()
            : this("mustang vibranium")
        {
        }

        [Constructable]
        public VibraniumMustang(string name)
