    ...
    public class SBBarkeeper : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                Add(new GenericBuyInfo("1041243", typeof(ContractOfEmployment), 3252, 20, 0x14F0, 0));
                Add(new GenericBuyInfo("a barkeep contract", typeof(BarkeepContract), 3252, 20, 0x14F0, 0));
                //if (Multis.BaseHouse.NewVendorSystem)
                Add(new GenericBuyInfo("1062332", typeof(VendorRentalContract), 3252, 20, 0x14F0, 0x672));
                /*if ( Map == Tokuno )
                {
