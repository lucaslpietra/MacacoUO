    ...
    public class SBJewel : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                Add(new GenericBuyInfo(typeof(StarSapphire), 125, 5, 0x0F0F, 0, true));
                Add(new GenericBuyInfo(typeof(Emerald), 100, 5, 0xF10, 0, true));
                Add(new GenericBuyInfo(typeof(Sapphire), 100, 5, 0xF19, 0, true));
                Add(new GenericBuyInfo(typeof(Ruby), 75, 5, 0xF13, 0, true));
                Add(new GenericBuyInfo(typeof(Citrine), 50, 5, 0xF15, 0, true));
                Add(new GenericBuyInfo(typeof(Amethyst), 100, 5, 0xF16, 0, true));
                Add(new GenericBuyInfo(typeof(Tourmaline), 75, 5, 0x0F18, 0, true));
                Add(new GenericBuyInfo(typeof(Amber), 50, 5, 0xF25, 0, true));
                Add(new GenericBuyInfo(typeof(Diamond), 200, 5, 0xF26, 0, true));
            }
        }
