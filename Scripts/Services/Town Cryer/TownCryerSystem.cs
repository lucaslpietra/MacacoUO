    ...
    public static class TownCryerSystem
    {
        ...
        public static void GetContextMenus(TownCrier tc, Mobile from, List<ContextMenuEntry> list)
        {
            if (from is PlayerMobile)
            {
                ...
                if (g != null && pm.GuildRank != null && pm.GuildRank.Rank >= 3 && g.Leader == pm && (pm.AccessLevel > AccessLevel.VIP || g.Members.Count >= MinGuildMemberCount))
                {
    ...
    public class UpdateGuildEntry : ContextMenuEntry
    {
        ...
        public override void OnClick()
        {
            ...
            if(pm != null)
            {
                ...
                if (g != null && pm.GuildRank != null && pm.GuildRank.Rank >= 3 && (pm.AccessLevel > AccessLevel.VIP || g.Members.Count >= TownCryerSystem.MinGuildMemberCount))
                {
