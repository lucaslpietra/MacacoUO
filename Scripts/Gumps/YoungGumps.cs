...
namespace Server.Gumps
{
    public class YoungDungeonWarning : Gump
    {
            ...
            : base(150, 200)
        {
            ...
            this.AddHtml(20, 43, 215, 70, "Cuidado ! Monstros podem lhe atacar aqui mesmo voce sendo um iniciante !", true, true); // Warning: monsters may attack you on site down here in the dungeons!
