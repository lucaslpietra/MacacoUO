...
namespace Server
{
    ...
    public class SkillInfo
    {
        ...
        private static SkillInfo[] m_Table = new SkillInfo[58]
        {
            ...
            new SkillInfo(3, "Item Identification", 0.0, 0.0, 0.0, "Mercador", null, 0.0, 0.0, 1.0, EASY, StatCode.Int, StatCode.Dex),
            new SkillInfo(4, "Arms Lore", 0.0, 0.0, 0.0, "Armeiro", null, 0.75, 0.15, 0.1, EASY, StatCode.Int, StatCode.Str),
            new SkillInfo(5, "Parrying", 7.5, 2.5, 0.0, "Duelista", null, 0.75, 0.25, 0.0, MEDIUM, StatCode.Dex, StatCode.Str, true ),
            ...
            new SkillInfo(9, "Peacemaking", 0.0, 0.0, 0.0, "Pacificador", null, 0.0, 0.0, 0.0, EASY, StatCode.Int, StatCode.Dex, true ),
            ...
            new SkillInfo(14, "Detecting Hidden", 0.0, 0.0, 0.0, "Escouta", null, 0.0, 0.4, 0.6, EASY, StatCode.Int, StatCode.Dex),
            new SkillInfo(15, "Discordance", 0.0, 2.5, 2.5, "Desmoralizador", null, 0.0, 0.25, 0.25, EASY, StatCode.Dex, StatCode.Int, true ),
            new SkillInfo(16, "Evaluating Intelligence", 0.0, 0.0, 0.0, "Sabio", null, 0.0, 0.0, 1.0, EASY, StatCode.Int, StatCode.Str),
            new SkillInfo(17, "Healing", 6.0, 6.0, 8.0, "Curandeiro", null, 0.6, 0.6, 0.8, MEDIUM, StatCode.Int, StatCode.Dex),
            ...
            new SkillInfo(22, "Provocation", 0.0, 4.5, 0.5, "Provocador", null, 0.0, 0.45, 0.05, EASY, StatCode.Int, StatCode.Dex, true ),
            ...
            new SkillInfo(30, "Poisoning", 0.0, 4.0, 16.0, "Assassino", null, 0.0, 0.4, 1.6, EASY, StatCode.Int, StatCode.Dex, true ),
            new SkillInfo(31, "Archery", 2.5, 7.5, 0.0, "Arqueiro", null, 0.25, 0.75, 0.0, EASY, StatCode.Dex, StatCode.Str, true ),
            new SkillInfo(32, "Spirit Speak", 0.0, 0.0, 0.0, "Medium", null, 0.0, 0.0, 1.0, EASY, StatCode.Int, StatCode.Str, false, true),
            ...
            new SkillInfo(40, "Swordsmanship", 7.5, 2.5, 0.0, "Espacachim", null, 0.75, 0.25, 0.0, EASY, StatCode.Str, StatCode.Dex, true ),
            new SkillInfo(41, "Mace Fighting", 9.0, 1.0, 0.0, "Maceiro", null, 0.9, 0.1, 0.0, EASY, StatCode.Str, StatCode.Dex, true ),
            new SkillInfo(42, "Fencing", 4.5, 5.5, 0.0, "Esgrimista", null, 0.45, 0.55, 0.0, EASY, StatCode.Dex, StatCode.Str, true ),
            new SkillInfo(43, "Wrestling", 9.0, 1.0, 0.0, "Boxer", null, 0.9, 0.1, 0.0, EASY, StatCode.Str, StatCode.Dex, true ),
            ...
            new SkillInfo(46, "Meditation", 0.0, 0.0, 0.0, "Meditador", null, 0.0, 0.0, 1.0, HARD, StatCode.Int, StatCode.Str),
            new SkillInfo(47, "Stealth", 0.0, 0.0, 0.0, "Ladino", null, 0.0, 1.0, 0.0, MEDIUM, StatCode.Dex, StatCode.Int),
            new SkillInfo(48, "Remove Trap", 0.0, 0.0, 0.0, "Trapeiro", null, 0.0, 0.0, 0.0, EASY, StatCode.Dex, StatCode.Int),
            new SkillInfo(49, "Necromancy", 0.0, 0.0, 0.0, "Necromante", null, 0.0, 0.0, 1.5, MEDIUM, StatCode.Int, StatCode.Str, true ),
            new SkillInfo(50, "Focus", 0.0, 0.0, 0.0, "Concentrador", null, 0.0, 0.0, 0.0, HARD, StatCode.Dex, StatCode.Int),
            new SkillInfo(51, "Chivalry", 0.0, 0.0, 0.0, "Paladino", null, 1.0, 0.0, 1.0, EASY, StatCode.Str, StatCode.Int, true ),
            new SkillInfo(52, "Bushido", 0.0, 0.0, 0.0, "Samurai", null, 1.0, 1.0, 0.0, MEDIUM, StatCode.Str, StatCode.Int, true ),
            new SkillInfo(53, "Ninjitsu", 0.0, 0.0, 0.0, "Ninja", null, 0.0, 2.0, 0.0, EASY, StatCode.Dex, StatCode.Int, true ),
            new SkillInfo(54, "Spellweaving", 0.0, 0.0, 0.0, "Arcanista", null, 0.0, 0.0, 2.0, HARD, StatCode.Int, StatCode.Str, true),
            new SkillInfo(55, "Mysticism", 0.0, 0.0, 0.0, "Mystico", null, 0.0, 0.0, 2.0, MEDIUM, StatCode.Str, StatCode.Int, true ),
