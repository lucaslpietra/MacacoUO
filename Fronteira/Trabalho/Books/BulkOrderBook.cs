...
namespace Server.Engines.BulkOrders
{
    public class BulkOrderBook : Item, ISecurable
    {
        ...
        {
            from.SendMessage(38, "[Atencao] Ao retirar suas ordens do livro, elas terao um tempo para serem cumpridas e nao poderao ser adicionadas no livro novamente.");
        ...
        {
            from.SendMessage("Desabilitado, por hora.");
            return;
