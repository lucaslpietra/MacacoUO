        ...
        public bool CheckFilter(BulkMaterialType mat, int amountMax, bool isLarge, bool reqExc, BODType deedType, Type itemType)
        {
            ...
            if (BulkOrderSystem.NewSystemEnabled)
            {
                switch (f.Material)
                {
                    ...
                    case 10:
                        return (mat == BulkMaterialType.Cobre && deedType == BODType.Smith);
                    case 11:
                        return (mat == BulkMaterialType.Bronze && deedType == BODType.Smith);
                    case 12:
                        return (mat == BulkMaterialType.Dourado && deedType == BODType.Smith);
                    case 13:
                        return (mat == BulkMaterialType.Niobio && deedType == BODType.Smith);
                    case 14:
                        return (mat == BulkMaterialType.Lazurita && deedType == BODType.Smith);
                    case 15:
                        return (mat == BulkMaterialType.Quartzo && deedType == BODType.Smith);
                    case 16:
                        return (mat == BulkMaterialType.Berilo && deedType == BODType.Smith);
                    case 17:
                        return (mat == BulkMaterialType.Vibranium && deedType == BODType.Smith);
                    ...
                    case 24:
                        return (mat == BulkMaterialType.Cobre && deedType == BODType.Tinkering);
                    case 25:
                        return (mat == BulkMaterialType.Bronze && deedType == BODType.Tinkering);
                    case 26:
                        return (mat == BulkMaterialType.Dourado && deedType == BODType.Tinkering);
                    case 27:
                        return (mat == BulkMaterialType.Niobio && deedType == BODType.Tinkering);
                    case 28:
                        return (mat == BulkMaterialType.Lazurita && deedType == BODType.Tinkering);
                    case 29:
                        return (mat == BulkMaterialType.Quartzo && deedType == BODType.Tinkering);
                    case 30:
                        return (mat == BulkMaterialType.Berilo && deedType == BODType.Tinkering);
                    case 31:
                        return (mat == BulkMaterialType.Vibranium && deedType == BODType.Tinkering);

                    case 32: // Carpentry
                        return (mat == BulkMaterialType.None && deedType == BODType.Carpentry);
                    case 33:
                        return (mat == BulkMaterialType.Carvalho && deedType == BODType.Carpentry);
                    case 34:
                        return (mat == BulkMaterialType.Pinho && deedType == BODType.Carpentry);
                    case 35:
                        return (mat == BulkMaterialType.Mogno && deedType == BODType.Carpentry);
                    case 36:
                        return (mat == BulkMaterialType.Carmesin && deedType == BODType.Carpentry);
                    case 37:
                        return (mat == BulkMaterialType.Eucalipto && deedType == BODType.Carpentry);
                    case 38:
                        return (mat == BulkMaterialType.Gelo && deedType == BODType.Carpentry);

                    case 39: // Fletching
                        return (mat == BulkMaterialType.None && deedType == BODType.Fletching);
                    case 40:
                        return (mat == BulkMaterialType.Carvalho && deedType == BODType.Fletching);
                    case 41:
                        return (mat == BulkMaterialType.Pinho && deedType == BODType.Fletching);
                    case 42:
                        return (mat == BulkMaterialType.Mogno && deedType == BODType.Fletching);
                    case 43:
                        return (mat == BulkMaterialType.Carmesin && deedType == BODType.Fletching);
                    case 44:
                        return (mat == BulkMaterialType.Eucalipto && deedType == BODType.Fletching);
                    case 45:
                        return (mat == BulkMaterialType.Gelo && deedType == BODType.Fletching);
                }
            }
            else
            {
                switch (f.Material)
                {
                    ...
                    case 4: return (mat == BulkMaterialType.Cobre);
                    case 5: return (mat == BulkMaterialType.Bronze);
                    case 6: return (mat == BulkMaterialType.Dourado);
                    case 7: return (mat == BulkMaterialType.Niobio);
                    case 8: return (mat == BulkMaterialType.Lazurita);
                    case 9: return (mat == BulkMaterialType.Quartzo);
                    case 10: return (mat == BulkMaterialType.Berilo);
                    case 11: return (mat == BulkMaterialType.Vibranium);
