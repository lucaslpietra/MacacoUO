...
namespace Server.Commands
{
    ...
    public class LoggingCustom
    {
        ...
        public static FileInfo ShopFile { get { return IOUtility.EnsureFile("Logs/Custom/Shop.txt"); } }
        ...
        public static void LogUberScript(string path, params string[] lines)
        {
            ...
            {
                path = "Logs" + IOUtility.PathSeparator + "UberScript" + IOUtility.PathSeparator + path;
            }
        ...
        public static void Log(string path, params string[] lines)
        {
            ...
            {
                path = "Logs" + IOUtility.PathSeparator + "Custom" + IOUtility.PathSeparator + path;
            }
        ...
        public static void LogShop(params string[] lines)
        {
            Log(ShopFile, lines);
        }
