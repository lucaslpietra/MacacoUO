...
namespace Server.Engines.MurderSystem
{
    ...
    public class VictimBuyHeadGump : HeadNegotiateGump
    {
        ...
        private void OnAccept()
        {
            ...
            Type cType = typeof(Gold);

            int bal = Banker.GetBalance(User);
            ...
            new KillerReceiveOfferGump(_Killer, (PlayerMobile)User, Head, _Offer, _Message).Send();
            ...
            LoggingCustom.Log(
                ...
                String.Format(
                    ...
                    DateTime.Now.ToSimpleString("t@h:m@ d-m-y"),
                    User,
                    _Killer,
                    Head,
                    _Offer,
    ...
    public class KillerSellHeadGump : HeadNegotiateGump
    {
        ...
        private void OnAccept()
        {
			...
			*/
            ...
            new VictimReceiveOfferGump(_Victim, (PlayerMobile)User, Head, _Offer, _Message).Send();
    ...
    public class VictimReceiveOfferGump : HeadNegotiateGump
    {
        ...
        protected override void CompileLayout(SuperGumpLayout layout)
        {
            ...
            layout.Add(
                "open", () => AddButton(21, 0, 30, 30, b => new VictimResponseGump((PlayerMobile) User, _Killer, Head, _Offer, _Message).Send()));
    ...
    public class VictimResponseGump : HeadNegotiateGump
    {
        ...
        private void OnAccept()
        {
            ...
            if (!Banker.Withdraw(User, _Offer))
            {
            ...
            Banker.Deposit(_Killer, _Offer);
            
            BankBox bank = User.BankBox;
        ...
        private void OnCounteroffer()
        {
            ...
            new KillerReceiveOfferGump(_Killer, (PlayerMobile)User, Head, _CounterOffer, _ReplyMessage).Send();
    ...
    public class KillerReceiveOfferGump : HeadNegotiateGump
    {
        ...
        protected override void CompileLayout(SuperGumpLayout layout)
        {
            ...
            layout.Add(
                "open", () => AddButton(21, 0, 30, 30, b => new KillerResponseGump((PlayerMobile)User, _Victim, Head, _Offer, _Message).Send()));
    ...
    public class KillerResponseGump : HeadNegotiateGump
    {
        ...
        private void OnAccept()
        {
            ...
            if (!Banker.Withdraw(_Victim, _Offer))
            {
            ...
            Banker.Deposit(User, _Offer);

            BankBox bank = _Victim.BankBox;
        ...
        private void OnCounteroffer()
        {
			...
			*/
            ...
            new VictimReceiveOfferGump(_Victim, (PlayerMobile)User, Head, _CounterOffer, _ReplyMessage).Send();
