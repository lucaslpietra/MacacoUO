...
namespace Server.Leilaum
{
	public class StaffCloak : Cloak
	{
		...
		public override void OnAdded( object parent )
		{
			...
			if ( RootParent is PlayerMobile && ( (PlayerMobile)RootParent ).AccessLevel <= AccessLevel.VIP )
			{
		...
		{
			if( HomeMap != Map.Internal && HomeMap != null && from.AccessLevel > AccessLevel.VIP )
			{
		...
		public StaffCloak() : base()
		{
			...
			Name = "Capa Marota do Staff Tester";
			Weight = 0;
		}
