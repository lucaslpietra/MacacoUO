...
namespace Server.Engines.ResortAndCasino
{
    ...
    public class CasinoWaitress : BaseVendor
    {
        ...
        public void GiveDrink(Mobile m)
        {
            ...
            SayTo(m, "Aqui esta sua bebida. Gorjetas sao bem vindas ;)"); // Here you are, hun. - Drink up! - Enjoy the drink. Tips are appreciated!
        }
        ...
        public override void OnThink()
        {
            ...
            if (canspeak)
                Say("Oi delicinha. Que tal uma bebidinha ?");
        ...
        public override bool OnGoldGiven(Mobile from, Gold dropped)
        {
            ...
            SayTo(from, "Obrigado, delicinha"); // Oh, thank you dearie!
            dropped.Delete();
            return true;
        }
