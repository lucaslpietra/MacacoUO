...
namespace Server.Items.Crops
{
	public class BlackberrySeed : BaseSeed
	{
        ...
        public override Item GetSeedling(Mobile from)
        {
            return new BlackberrySeedling(from);
        }
    }
	...
	{
		[Constructable]
		public BlackberrySeedling( Mobile sower ) : base(sower, 0xC61)
		{
			Movable = false;
        ...
        {
            return typeof(BlackberryCrop);
        }

    }

	public class BlackberryCrop : HerdingBaseCrop
	{
