...
namespace Custom.Gumps
{
	public class SeedBoxGumpExp : Gump
	{
		...
		{
            "Camellia", "Papoulas", "Pingo de Neve", "Burtsim",
			"Lirios", "Pampas", "Rushes", "Orelhas de Elefante",
			"Samambaia", "Palmeira", "Palmeira Pequena", "Palmeira Centenaria",
			"Planta Dagua", "Planta Cobra", "Cactus Pera", "Cactus Barril",
			"Cactus Tribarril"
		};
		...
		public SeedBoxGumpExp( Mobile owner , SeedBoxExp box, int PlantId ) : base( 10, 10 )
		{
			...
			AddLabel(103, 35, 1152, "Tipos de Semente");
			AddLabel(423, 36, 1152, "Cores de Semente");
			...
			if ( info.ButtonID >= 18 )
			{
				...
				if ( bid != -1 )
				{
					...
					if ( m_box.m_counts[ m_id, bid ] > 0 )
					{
						...
						from.SendMessage( "Voce nao tem nenhuma dessas sementes!" );
