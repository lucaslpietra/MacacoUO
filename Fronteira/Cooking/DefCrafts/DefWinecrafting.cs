...
namespace Server.Engines.Craft
{
    ...
    public class DefWinecrafting : CraftSystem
	{
		...
		{
			get { return "<basefont color=#FFFFFF><CENTER>Criacao de Vinhos</CENTER></basefont>"; }
		}
		...
		public override void InitCraftList()
		{
			...
			AddSubRes(typeof(PinotNoirGrapes), "Pinot Noir", 80.0, skillNotice);
			AddSubRes(typeof(RieslingGrapes), "Riesling", 85.0, skillNotice);
			AddSubRes(typeof(SangioveseGrapes), "Sangiovese", 90.0, skillNotice);
			AddSubRes(typeof(SauvignonBlancGrapes), "Sauvignon Blanc", 90.0, skillNotice);
			AddSubRes(typeof(ShirazGrapes), "Shiraz", 90.0, skillNotice);
			AddSubRes(typeof(ViognierGrapes), "Viognier", 99.0, skillNotice);
			AddSubRes(typeof(ZinfandelGrapes), "Zinfandel", 80.0, skillNotice);
			AddSubRes(typeof(Apple), "Maca", 60.0, skillNotice);
			AddSubRes(typeof(Apricot), "Apricots", 70.0, skillNotice);
			AddSubRes(typeof(Cherry), "Cereja", 80.0, skillNotice);
