...
namespace Server.Engines.Quests
{
    public class HoneyCombs : BaseQuest
    {
        ...
        public HoneyCombs()
            : base()
        {
            AddObjective(new ObtainObjective(typeof(HoneyComb), "Colmeias", 10, 0x1762));
            AddObjective(new SlayObjective(typeof(BlackBear), "Urso Negro", 5));
            AddReward(new BaseReward(typeof(HoneycombProcessingKettle), "Caldeira de Colmeia"));
        }
